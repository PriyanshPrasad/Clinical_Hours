...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#edf8f7] text-[#18364a]">
      ...
      <footer className="border-t border-[#dbecea] px-6 py-6 text-center text-xs text-[#78919b]"><span className="font-semibold text-[#4f7581]">Your data stays in this browser. Avoid sensitive patient details.</span><span className="mx-2 hidden sm:inline">·</span><span className="mt-2 block sm:mt-0 sm:inline">ClinicalHours · Track your experience. Build your future. · Local-first demo</span></footer>
    </div>
  );
}
